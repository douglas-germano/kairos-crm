...
export function SidebarMenuButton({
  ...
  return (
    <Comp
      ...
      className={cn(
        "focus-ring relative flex h-10 w-full items-center gap-3 overflow-hidden rounded-card px-3 text-left text-sm font-medium outline-none transition-colors duration-fast ease-brand",
        "before:absolute before:inset-y-[7px] before:left-0 before:w-[3px] before:rounded-full before:bg-brand-red before:transition-transform before:duration-fast before:ease-brand before:content-['']",
        isActive
          ? "bg-sidebar-accent font-semibold text-sidebar-accent-foreground before:scale-y-100"
          : "text-brand-muted before:scale-y-0 hover:bg-brand-canvas hover:text-brand-ink",
